 ...
 */
public class WordCountToMaster3 extends Configured implements Tool{
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(WordCountToMaster3.class);
...
//        job.setNumReduceTasks();
    ...
    public static void main(String[] args) throws Exception {
        ...
        int status = ToolRunner.run(conf, new WordCountToMaster3(), args);
        System.exit(status);
    }
}
